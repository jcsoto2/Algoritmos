        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-end">
                ...
                <?php if (current_user()): ?>
                    ...
                    <a class="navbar-item" href="<?= site_url("/tasks") ?>">Tareas</a>
                    
                    <a class="navbar-item" href="<?= site_url("/logout") ?>">Cerrar sesion</a>
                    
                <?php else: ?>
                    
                    <a class="navbar-item" href="<?= site_url("/signup") ?>">Registrarse</a>    
                    
                    <a class="navbar-item" href="<?= site_url("/login") ?>">Iniciar sesion</a>
